;(function ($, window, document, undefined) {
  ...
  var Orbit = function(el, settings) {
    ...
    self.compute_dimensions = function() {
      ...
      slides_container.height(h);
          $('.orbit-container li').css('height','100%');
    };
  ...
  var SlideAnimation = function(settings, container) {
    ...
    this.next = function(current, next, callback) {
      next.css(margin, '100%');
      next.animate({ 'margin-left': '0%' }, duration, 'linear',function(){
        callback();
      });
      current.animate({ 'margin-left': '-100%' }, duration,'linear' );
    ...
    this.prev = function(current, prev, callback) {
      prev.css(margin, '-100%');
      prev.animate({ 'margin-left': '0%' }, duration, 'linear',function(){
        callback();
      });
      current.animate({ 'margin-left': '100%' }, duration );
  ...
  var FadeAnimation = function(settings, container) {
    ...
    this.next = function(current, next, callback) {
      next.css({'margin-left':'0%', 'opacity':'0.01'});
    ...
    this.prev = function(current, prev, callback) {
      prev.css({'margin-left':'0%', 'opacity':'0.01'});
